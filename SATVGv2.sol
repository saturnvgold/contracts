...
Y88b.               888                             888     888      888    888          888      888 
 "Y888b.    8888b.  888888 888  888 888d888 88888b. Y88b   d88P      888         .d88b.  888  .d88888 
    "Y88b.     "88b 888    888  888 888P"   888 "88b Y88b d88P       888  88888 d88""88b 888 d88" 888 
      "888 .d888888 888    888  888 888     888  888  Y88o88P        888    888 888  888 888 888  888 
Y88b  d88P 888  888 Y88b.  Y88b 888 888     888  888   Y888P         Y88b  d88P Y88..88P 888 Y88b 888 
 "Y8888P"  "Y888888  "Y888  "Y88888 888     888  888    Y8P           "Y8888P88  "Y88P"  888  "Y88888 
...
Transaction Tax: 3%
    1% auto yield direct to holders (no staking)
    1% Burn Rate per tx
...
contract SATVGv2 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 165 * 10**5 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SaturnV Gold v2";
    string private _symbol = "SATVGv2";
    uint8 private _decimals = 18;
    
    uint256 private constant DIVISION_FACTOR = 4;   // fee precision up to 2 decimals
    uint256 public _taxFee = 100;                   // 100 = 1.00%
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 100;             // 100 = 1.00%
    ...
    uint256 private numTokensSellToAddToLiquidity = 2 * 10**4 * 10**18;
    ...
    function tokenRescue(address _recipient, address _ERC20address, uint256 _amount) public onlyOwner returns(bool) {
